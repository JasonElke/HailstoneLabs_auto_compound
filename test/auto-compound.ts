...
describe('AutoCompounder', () => {
  ...
  let signer: Signer;
  const {BSC_TESTNET_URL, PRIVATE_KEY, WOM_TOKEN_ADDRESS, USDC_TOKEN_ADDRESS, LP_TOKEN_ADDRESS, MAIN_POOL_ADDRESS, MASTER_WOMBAT_V2_ADDRESS, LP_PANCAKE_V3_ADDRESS } = process.env;
  if (!BSC_TESTNET_URL || !PRIVATE_KEY || !WOM_TOKEN_ADDRESS || !USDC_TOKEN_ADDRESS || !LP_TOKEN_ADDRESS || !MAIN_POOL_ADDRESS || !MASTER_WOMBAT_V2_ADDRESS || !LP_PANCAKE_V3_ADDRESS) {
